...
class DosesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dose" do
    assert_difference('Dose.count') do
      post doses_url, params: { dose: { cocktail_id: @dose.cocktail_id, description: @dose.description, ingredient_id: @dose.ingredient_id } }
    end
  ...
  test "should update dose" do
    patch dose_url(@dose), params: { dose: { cocktail_id: @dose.cocktail_id, description: @dose.description, ingredient_id: @dose.ingredient_id } }
